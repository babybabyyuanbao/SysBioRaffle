...
Raffle app for selecting people from @SysBioChalmers. Runs on MATLAB and uses random numbers from https://www.random.org/. By changing folder "contendants" it can be used for other purposes as well.
